...
public class ConfigPropertiesLoader implements BeanFactoryPostProcessor, PriorityOrdered {

  private static Logger logger = LoggerFactory.getLogger(ConfigPropertiesLoader.class);
